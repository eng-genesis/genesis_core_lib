...
GENESIS Core Lib is the algorithmic core of the [GENESIS](https://eng-genesis.github.io/genesis/) project. All developments are focused on building a compact, easy to use system for everyone.
